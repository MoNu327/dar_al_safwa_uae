...
class HomeScreen extends StatelessWidget {
  ...
  // ✅ FIXED: Display price with line break to prevent truncation
  String getFormattedPriceWithAnnually(dynamic priceData, bool isArabic) {
    ...
    try {
      final raw = priceData.raw;
      
      if (raw == null || raw.toString().isEmpty) {
        return isArabic ? 'السعر غير متاح' : 'Price unavailable';
      }
      
      String priceStr = raw.toString();
      
      // Format with line break to show full price on first line
      if (isArabic) {
        return 'ر.ع $priceStr\n/سنوياً';
      } else {
        return 'AED $priceStr\n/yr';
