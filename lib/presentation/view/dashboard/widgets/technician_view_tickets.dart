...
class _TechnicianViewTicketsState extends State<TechnicianViewTickets> {
  ...
  void initState() {
    ...
    if (userId != null) {
      ...
      controller.getAvailableTechnicians(); // Load available technicians
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     date: DateFormatter.formatCurrentDate(),
                ...
                complaintNumber: ticket.complaintNumber ?? "",
                 ...
                 description: ticket.description ?? "", 
                 amountPaid:  "N/A" ?? "0", amountPaidStatus: "",
                  status: TicketStatus.pending, lastUpdated: "",
                   images: ticket.images ?? [], replyByTechnician: '',
                    replyByAdmin: '', property: ticket.propertyName), mobile: '', name: '', time: '' 
              ),
            );
          },
        );
